...
class DaggerInjectorTest {
    ...
    private val subcomponent: BaseDaggerSubcomponent<InjectionTarget> = BaseDaggerSubcomponentImplementation()
...
private class BaseDaggerSubcomponentFactory<T : InjectionTarget>(override val key: Class<T>,
